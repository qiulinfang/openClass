<template>
  <BaseQuestion :question="question" :show-title="showTitle" :show-id="showId" :show-analysis="showAnalysis">
    ...
    <view class="judgment-actions">
      ...
      >
        <text class="label">{{ correctDisplay }}</text>
        <view class="status-icon" v-if="disabled && modelValue === correctLabel">
          <text v-if="isCorrect(correctLabel)" class="status-icon-correct">L</text>
          <text v-else class="status-icon-wrong">X</text>
        </view>
      </view>
      <view 
      ...
      >
        <text class="label">{{ wrongDisplay }}</text>
        <view class="status-icon" v-if="disabled && modelValue === wrongLabel">
          <text v-if="isCorrect(wrongLabel)" class="status-icon-correct">L</text>
          <text v-else class="status-icon-wrong">X</text>
        </view>
      </view>
    </view>
