<template>
  <view class="similar-question-list">
    <!-- 相似题目列表 -->
    <RubberBandList
      ref="rubberBandRef"
      :enable-refresh="true"
      ...
      <view class="scroll-content">
        <view class="q-pa-md">
          ...
          <view v-if="loading" class="loading-container">
            <BaseLoading text="查找相似题目中..." :size="48" theme="dark" />
          </view>

        <!-- 空状态 -->
        <view v-else-if="!loading && similarQuestions.length === 0" class="native-empty-state">
          <view class="text-h6 q-mt-md text-grey-7 native-text-3xl">未找到相似题目</view>
          <view class="text-body2 text-grey-6 q-mt-sm native-text-md">
        ...
        <view v-else-if="!loading && similarQuestions.length > 0" class="similar-questions-container">
          <view
          ...
          >
            ...
            <view class="question-block">
              ...
              >
                <rich-text
                  :nodes="renderMarkdown(getQuestionContent(question))"
