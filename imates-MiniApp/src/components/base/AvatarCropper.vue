<template>
  <Teleport to="body">
    <view v-if="modelValue" class="avatar-crop-overlay" @click.self="handleCancel">
      <view class="avatar-crop-container" @click.stop>
        <canvas
          ref="canvasRef"
          class="crop-canvas"
        ...
        <view class="crop-actions">
          <BaseButton variant="ghost" @click="reset" :disabled="!isReady">重置</BaseButton>
          <BaseButton
            variant="primary"
            :disabled="!isReady"
            @click="handleConfirm"
        ...
        <BaseButton variant="ghost" size="sm" @click="handleCancel" class="crop-close-btn goback-btn">
