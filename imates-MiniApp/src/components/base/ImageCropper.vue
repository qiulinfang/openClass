<template>
  <view :is="isInline ? 'view' : 'Teleport'" :to="isInline ? undefined : 'body'">
    <view v-if="modelValue" :class="['image-crop-overlay', { 'is-inline': isInline }]" @click.self="handleCancel">
      <view class="image-crop-container">
        <view class="crop-container">
          ...
          <!-- 灰色蒙版层 -->
          <view v-if="!cropRect" class="crop-mask crop-mask-full">
            <view class="crop-hint-box">
              <view class="crop-hint-rect"></view>
              <view class="crop-hint-text">{{ hintText }}</view>
            </view>
          </view>
          <template v-else>
            <view class="crop-mask crop-mask-top" :style="cropMaskTopStyle"></view>
            <view class="crop-mask crop-mask-bottom" :style="cropMaskBottomStyle"></view>
            <view class="crop-mask crop-mask-left" :style="cropMaskLeftStyle"></view>
            <view class="crop-mask crop-mask-right" :style="cropMaskRightStyle"></view>
          </template>

          <!-- 框选遮罩（中间透明显示清晰图片） -->
          <view v-if="cropRect" class="crop-overlay" :style="cropOverlayStyle">
            <view class="crop-corner crop-corner-nw"></view>
            <view class="crop-corner crop-corner-ne"></view>
            <view class="crop-corner crop-corner-sw"></view>
            <view class="crop-corner crop-corner-se"></view>
          </view>
        </view>
        ...
        <Button variant="ghost" size="sm" @click="handleCancel" class="capture-close-btn goback-btn">
