      ...
      <view class="split-pane-root">
        ...
        >
          ...
          >
            <!-- 左侧内容插槽 -->
            <slot name="left">
              <view class="placeholder-text">左侧区域插槽内容</view>
            </slot>
          </view>
          ...
          >
              <view class="pane-content-wrapper">
                <!-- 右侧内容插槽 -->
                <slot name="right">
                  <view class="placeholder-text">右侧区域插槽内容</view>
                </slot>
              </view>
              ...
              >
                <image :src="seekbarIcon" mode="aspectFit" class="splitter-handle" />
              </view>
          </view>
        </view>
      </view>
