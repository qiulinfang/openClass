<template>
  ...
  >
    <view class="camera-upload-content">
      <!-- 照片网格区域 -->
      <view class="photo-grid-section">
        <view class="question-sections">
          <view
            v-for="section in groupedPhotoSections"
            :key="section.questionIndex"
            class="question-section"
          >
            <view class="question-title">第{{ section.questionNo }}题</view>
            <view class="photo-grid">
              ...
              <!-- 每个题目分区独立的添加照片按钮 -->
              <view class="add-photo-btn" @click="openCamera(section.questionIndex)">
                <image src="/icons/add.svg" style="width: 32px; height: 32px;" class="q-icon-fallback" />
              </view>
            </view>
          </view>
        </view>
