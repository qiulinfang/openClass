    ...
    >
      <view class="profile-dialog-content">
        ...
        <view class="profile-list">
          <!-- 头像项 -->
          <view class="list-item avatar-item" @click="handleAvatarClick">
            <view class="item-label">头像</view>
            <view class="item-content">
              <view class="user-avatar-list">
                <image :src="currentAvatar" mode="aspectFill" class="avatar-image-list" />
                <view class="avatar-overlay-list">
                  <text class="change-avatar-text">更换</text>
                </view>
              </view>
            </view>
          ...
          <view class="list-item logout-item" @click="handleLogout">
            <view class="item-label logout-label">退出登录</view>
            <view class="item-content">
            </view>
            <view class="item-arrow">›</view>
          </view>
