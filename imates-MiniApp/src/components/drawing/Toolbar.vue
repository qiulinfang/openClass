<template>
  <view :class="['unified-toolbar-container', `variant-${variant}`, `orientation-${orientation}`]">
    <!-- 统一工具栏 -->
    <view
      :class="[
        'unified-toolbar',
    ...
    >
      <!-- 左侧插槽（工具栏外部） -->
      <view class="toolbar-slot toolbar-slot-left">
      ...
      >
        ...
        <view class="center-section">
          <view class="tool-row">
            ...
            <!-- 分隔线 -->
            <view v-if="drawingTools.length > 0" class="toolbar-divider-vertical"></view>
            ...
            <template v-for="tool in drawingTools" :key="tool.value">
              ...
              >
                ...
                <view class="combined-popup-content">
                  <view class="popup-inner">
                    <!-- 1. 子工具选择器 (如形状切换) -->
                    <view v-if="tool.subTools && tool.subTools.length > 0" class="config-section">
                    ...
                    <view v-if="getToolConfig(tool)" class="config-sections-wrapper">
                      <!-- 颜色配置 -->
                      <view v-if="getToolConfig(tool)?.showColorPicker" class="config-section">
                        <view class="section-title">
                          <text>颜色</text>
                        </view>
                        <view class="section-content">
                      ...
                      <!-- 粗细/大小配置 -->
                      <view v-if="getToolConfig(tool)?.showSizePicker" class="config-section">
                        <view class="section-title">
                          <text>{{ getToolConfig(tool)?.sizeLabel || '粗细' }}</text>
                        </view>
                        <view class="section-content">
                          <view class="size-slider-wrapper" style="padding: 0 8px; width: 100%">
                            <PurpleSlider
                      ...
                      <!-- 透明度/浓度配置 -->
                      <view v-if="getToolConfig(tool)?.showOpacityPicker" class="config-section">
                        <view class="section-title">
                          <text>浓度</text>
                        </view>
                        <view class="section-content">
                      ...
                      >
                        <view class="section-title">
                          <text>{{ getToolConfig(tool)?.selectionModeLabel || '选择模式' }}</text>
                        </view>
                        <view class="section-content">
                          <view class="selection-mode-options">
                            <view
                            ...
                            >
                              <view class="selection-mode-icon">
                                <text class="mode-icon-placeholder">O</text>
                              </view>
                              <view class="selection-mode-info">
                                <view class="selection-mode-label">{{ mode.label }}</view>
                              </view>
                            </view>
                          </view>
                        </view>
        ...
        <view class="right-section">
          <!-- 分隔线 -->
          <view v-if="rightTools.length > 0" class="toolbar-divider"></view>
          <!-- 右侧工具按钮 -->
          <BaseButton
          ...
          >
            <!-- SVG 图标 -->
            <view v-if="isImageIcon(tool.icon)" :style="{
      ...
      <!-- 右侧插槽（工具栏外部） -->
      <view class="toolbar-slot toolbar-slot-right">
