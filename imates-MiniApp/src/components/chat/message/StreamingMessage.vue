  ...
  <view class="streaming-message">
    <view class="message-content">
      ...
      <view
        ...
        class="streaming-content-wrapper"
      >
        <rich-text :nodes="displayedContent" class="rich-content"></rich-text>
      </view>
      <!-- HTML 卡片 -->
      <view
      ...
      >
        <view v-for="seg in htmlSegments" :key="seg.key" class="html-segment-wrapper">
          ...
          <view v-if="seg.type === 'text'" class="html-text-segment">
            <rich-text :nodes="seg.rendered"></rich-text>
          </view>
          <!-- 网页 -->
          <view
            v-else
      ...
      <view v-else class="typewriter-content">
        <rich-text :nodes="displayedContent"></rich-text>
      </view>
    </view>
  </view>
</template>
...
// 移除不再使用的 ref 处理函数
const setStreamingContentRef = () => {}
const setTypewriterContentRef = () => {}
</script>
