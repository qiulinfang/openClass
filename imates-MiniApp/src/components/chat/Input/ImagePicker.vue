  ...
  <view class="image-picker">
    ...
    >
      ...
      <view class="picker-options">
        <!-- 相机选项 -->
        <view class="picker-option" @click="captureFromCamera">
          <image src="/icons/camera_alt.svg" style="width: 48px; height: 48px;" class="option-icon" />
          <text class="option-label">相机</text>
        </view>
        
        <!-- 相册选项 -->
        <view class="picker-option" @click="selectFromGallery">
          <image src="/icons/photo_library.svg" style="width: 48px; height: 48px;" class="option-icon" />
          <text class="option-label">相册</text>
        </view>
      </view>
    </Modal>
  </view>
