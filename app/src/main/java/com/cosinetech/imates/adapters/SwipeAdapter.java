...
public class SwipeAdapter extends BaseAdapter {
    ...
    public SwipeAdapter(Context ctx, int rightWidth, IOnItemRightClickListener l, List<String> items) {
        mContext = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.swipe_item, parent, false);
            item = new ViewHolder();
        ...
        item.item_left_txt.setText(mData.get(thisPosition));
