...
//                DevicePolicyManager.DISALLOW_INSTALL_UNKNOWN_SOURCES);
//
//        // 禁用USB文件传输
//        devicePolicyManager.addUserRestriction(adminComponent,
//                DevicePolicyManager.DISALLOW_USB_FILE_TRANSFER);
//
//        // 禁用工厂重置
//        devicePolicyManager.addUserRestriction(adminComponent,
//                DevicePolicyManager.DISALLOW_FACTORY_RESET);
//
//        // 禁用添加用户
//        devicePolicyManager.addUserRestriction(adminComponent,
//                DevicePolicyManager.DISALLOW_ADD_USER);
//
//        // 禁用卸载应用
//        devicePolicyManager.addUserRestriction(adminComponent,
//                DevicePolicyManager.DISALLOW_UNINSTALL_APPS);
//
//        // 禁用修改账户
//        devicePolicyManager.addUserRestriction(adminComponent,
//                DevicePolicyManager.DISALLOW_MODIFY_ACCOUNTS);
//
