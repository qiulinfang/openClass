...
public class ExerciseSolveWebViewActivity extends BaseActivity implements WebAppInterface.ExerciseSolveActivityBridge {
    ...
    private void initWebView() {
        ...
        // 只在 Debug 构建中启用，或者根据需要始终启用
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            WebView.setWebContentsDebuggingEnabled(BuildConfig.DEBUG || true); // 强制启用调试
        }
        ...
        // 加载本地Web应用
        webView.loadUrl("file:///android_asset/exercise-solve/index.html");
    }
