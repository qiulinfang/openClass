...
import static com.cosinetech.imates.ui.activities.ExerciseSolveActivity.createChatTeacherSession;
...
public class ChatAiActivity extends AppCompatActivity implements MessagingManager.MessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setLayout((int) (screenWidth * 0.80), metrics.heightPixels);
