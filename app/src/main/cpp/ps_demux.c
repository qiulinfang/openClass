...
static int handle_header(lt_demux *handle, uint8_t *buf, int len) {
	int psize = 0;
	int staffing_len = 0;
...
static int handle_system_header(lt_demux *handle, uint8_t *buf, int len) {
...
static int handle_map(lt_demux *handle, uint8_t *buf, int len) {
	int psize = handle_common_pack(buf, len);
...
static int handle_finish(lt_demux *handle, uint8_t *buf, int len) {
	int psize = 4;
	return psize;
}

static int handle_pes(lt_demux *handle, uint8_t *buf, int len) {
	int psize = handle_common_pack(buf, len);
