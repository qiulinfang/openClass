# gemini-notify.css PRD 文档

## 📋 概述

**文件路径**：`src/styles/gemini-notify.css`  
**文件类型**：`CSS 样式文件`  
...
.gemini-notify {
  ...
  animation: gemini-notify-enter 0.3s cubic-bezier(0.4, 0.0, 0.2, 1) !important;
