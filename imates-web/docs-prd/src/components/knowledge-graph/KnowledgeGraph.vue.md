# KnowledgeGraph.vue PRD 文档

## 📋 概述

**文件路径**：`src/components/knowledge-graph/KnowledgeGraph.vue`  
**文件类型**：`Vue 组件`  
**主要职责**：`位于 src/components/knowledge-graph 目录的 Vue 组件`
