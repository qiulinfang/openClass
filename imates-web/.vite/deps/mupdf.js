...
var _ = async function(_2 = {}) {
  ...
  if (m) {
    const { createRequire: _3 } = await import("./module-NQ2OTTYV.js");
    var r = _3(import.meta.url);
  }
  ...
  var I = (_3) => {
  ...
  }, B = [], q = (_3) => B.push(_3), L = [], W = (_3) => L.push(_3), z = true, H = new TextDecoder(), N = (_3, a2) => {
    if (!_3) return "";
    ...
    z || (t.onExit?.(_3), $ = true), w(_3, new P(_3));
  }, t_ = (_3, a2) => {
    e_(_3);
  }, s_ = [null, [], []], n_ = (_3, a2) => {
    var e2 = s_[_3];
  ...
  t.noExitRuntime && (z = t.noExitRuntime), t.print && (T = t.print), t.printErr && (j = t.printErr), t.wasmBinary && (u = t.wasmBinary), t.arguments && t.arguments, t.thisProgram && (d = t.thisProgram), t.UTF8ToString = N, t.stringToUTF8 = Y, t.lengthBytesUTF8 = a_;
  var i_ = { 6016e3: () => {
    throw "TRYLATER";
  }, 6016022: () => {
    throw "ABORT";
  ...
  }, 6016133: (_3, a2, e2, t2, s2, n2, i2) => {
    globalThis.$libmupdf_text_walk.begin_span(_3, a2, e2, t2, s2, n2, i2);
  }, 6016207: (_3, a2, e2, t2, s2, n2, i2, m2) => {
    globalThis.$libmupdf_text_walk.show_glyph(_3, a2, e2, t2, s2, n2, i2, m2);
  }, 6016285: (_3) => {
    globalThis.$libmupdf_text_walk.end_span(_3);
  }, 6016333: (_3, a2, e2, t2) => globalThis.$libmupdf_load_font_file(_3, a2, e2, t2), 6016396: (_3, a2, e2, t2) => globalThis.$libmupdf_stm_read(_3, a2, e2, t2), 6016454: (_3) => {
    globalThis.$libmupdf_stm_close(_3);
  }, 6016494: (_3, a2, e2, t2) => globalThis.$libmupdf_stm_seek(_3, a2, e2, t2), 6016552: (_3, a2, e2) => {
    globalThis.$libmupdf_path_walk.moveto(_3, a2, e2);
  }, 6016606: (_3, a2, e2) => {
    globalThis.$libmupdf_path_walk.lineto(_3, a2, e2);
  }, 6016660: (_3, a2, e2, t2, s2, n2, i2) => {
  ...
  }, 6016877: (_3, a2, e2, t2, s2, n2, i2, m2) => {
    globalThis.$libmupdf_device.fill_path(_3, a2, e2, t2, s2, n2, i2, m2);
  }, 6016951: (_3, a2, e2, t2, s2, n2, i2, m2) => {
  ...
  }, 6017150: (_3, a2, e2, t2, s2, n2, i2) => {
    globalThis.$libmupdf_device.fill_text(_3, a2, e2, t2, s2, n2, i2);
  }, 6017220: (_3, a2, e2, t2, s2, n2, i2, m2) => {
  ...
  return (function() {
    ...
    C > 0 ? S = _3 : ((function() {
      if (t.preRun) for ("function" == typeof t.preRun && (t.preRun = [t.preRun]); t.preRun.length; ) W(t.preRun.shift());
      I(L);
...
if (typeof process !== "undefined" && process.versions && process.versions.node)
  node_fs = await import("./node_fs-23V4EMJG.js");
...
var Document = class _Document extends Userdata {
  ...
  formatLinkURI(dest) {
    return fromStringFree(libmupdf._wasm_format_link_uri(this.pointer, dest.chapter | 0, dest.page | 0, ENUM(dest.type, _Document.LINK_DEST), +dest.x, +dest.y, +dest.width, +dest.height, +dest.zoom));
  }
  asPDF() {
  ...
  hasPermission(perm) {
    let perm_ix = _Document.PERMISSION[perm];
  ...
  resolveLinkDestination(link) {
    ...
    return {
      type: _Document.LINK_DEST[libmupdf._wasm_link_dest_get_type(dest)],
