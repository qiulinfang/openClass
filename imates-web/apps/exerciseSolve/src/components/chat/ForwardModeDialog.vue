<template>
  <q-dialog v-model="show" @hide="onHide" :maximized="$q.screen.lt.sm" :persistent="false" class="gemini-card-dialog">
    <q-card class="forward-mode-dialog">
      ...
      <q-card-section class="options-section">
        <div class="options-container">
          ...
          <div 
            ...
            role="button"
            tabindex="0"
            @keydown.enter="selectMode('merge')"
            @keydown.space.prevent="selectMode('merge')"
          >
            <div class="option-content">
              <div class="option-text">
                <div class="option-title">合并转发</div>
              </div>
          ...
          <div 
            ...
            role="button"
            tabindex="0"
            @keydown.enter="selectMode('separate')"
            @keydown.space.prevent="selectMode('separate')"
          >
            <div class="option-content">
              <div class="option-text">
                <div class="option-title">逐条转发</div>
              </div>
              <div class="option-check">
                <q-icon 
      ...
      <!-- 附加留言输入区域 -->
      <q-card-section v-if="selectedMode" class="additional-message-section">
