      ...
      <div className="panel-body">
        <div className="field">
          ...
          <input 
            ...
            step="0.05" 
            value={localMinScale}
            onChange={(e) => setLocalMinScale(Number(e.target.value))}
            onBlur={() => onMinScaleChange?.(localMinScale)}
          />
        ...
        <div className="field">
          ...
          <input 
            ...
            step="0.1" 
            value={localMaxScale}
            onChange={(e) => setLocalMaxScale(Number(e.target.value))}
            onBlur={() => onMaxScaleChange?.(localMaxScale)}
          />
        ...
        <div className="field">
          ...
          <input 
            ...
            onChange={(e) => setLocalZoomThreshold(Number(e.target.value))}
            onBlur={() => onZoomThresholdChange?.(localZoomThreshold)}
          />
        ...
        <div className="field">
          ...
          <input 
            ...
            onChange={(e) => setLocalPanThreshold(Number(e.target.value))}
            onBlur={() => onPanThresholdChange?.(localPanThreshold)}
          />
        ...
        <div className="field">
          ...
          <input 
            ...
            step="0.0005" 
            value={localFriction}
            onChange={(e) => setLocalFriction(Number(e.target.value))}
            onBlur={() => onFrictionChange?.(localFriction)}
          />
